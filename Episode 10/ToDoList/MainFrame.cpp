...
void MainFrame::CreateControls() {
    ...
    inputField = new wxTextCtrl(panel, wxID_ANY, "", wxPoint(100, 80), wxSize(495, 20), wxTE_PROCESS_ENTER);
    addButton = new wxButton(panel, wxID_ANY, "Add", wxPoint(600, 80), wxSize(100, -1));
    checkListBox = new wxCheckListBox(panel, wxID_ANY, wxPoint(100, 110), wxSize(600, 400));
    clearButton = new wxButton(panel, wxID_ANY, "Clear", wxPoint(100, 525), wxSize(100, -1));
}
